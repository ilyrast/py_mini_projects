    ...
    while True:
        ...
        if gameover(bulls=bulls):
            ...
            if input() == 'y':
                ...
                quit()  # TODO, к сожалению сразу не обратил внимание. Как закончить цикл без quit?

# TODO При вызове этого метода нужно гарантировать, что все финализаторы всяких объектов отработают.
# TODO Это прокатит при их вызове в del, но не везде это возможно.
# TODO Старайтесь избегать вызова quit, давайте программе штатно завершиться
